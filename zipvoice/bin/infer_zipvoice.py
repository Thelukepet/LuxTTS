...
def main():
    ...
    assert (params.test_list is not None) ^ ((params.prompt_wav and params.prompt_text and params.text) is not None), (
    ...
    if params.test_list:
        ...
        assert not params.raw_evaluation, "Raw evaluation is only valid with --test-list"
        generate_sentence(
